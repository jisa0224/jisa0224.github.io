# `~/.pam_environment`: 設定讓所有程式都可以使用的環境變數
...
重要：根據 <https://github.com/linux-pam/linux-pam/commit/ecd526743a27157c5210b0ce9867c43a2fa27784> 說明，未來可能 `~/.pam_environment` 不會被讀取。